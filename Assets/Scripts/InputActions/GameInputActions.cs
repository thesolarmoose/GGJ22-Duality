...
namespace InputActions
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""b54ecf1c-5ffc-48ec-b283-ed416eb4c47a"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""f59c1907-5864-4068-ad7e-739b04b34ed8"",
    ...
    ""controlSchemes"": [
        ...
        private List<IPuzzlePingActions> m_PuzzlePingActionsCallbackInterfaces = new List<IPuzzlePingActions>();
        ...
        public struct PuzzlePingActions
        {
            ...
            public void AddCallbacks(IPuzzlePingActions instance)
            {
                if (instance == null || m_Wrapper.m_PuzzlePingActionsCallbackInterfaces.Contains(instance)) return;
                m_Wrapper.m_PuzzlePingActionsCallbackInterfaces.Add(instance);
            ...
            private void UnregisterCallbacks(IPuzzlePingActions instance)
            {
                @asd.started -= instance.OnAsd;
                @asd.performed -= instance.OnAsd;
                @asd.canceled -= instance.OnAsd;
            ...
            public void RemoveCallbacks(IPuzzlePingActions instance)
            {
                if (m_Wrapper.m_PuzzlePingActionsCallbackInterfaces.Remove(instance))
                    UnregisterCallbacks(instance);
            }

            public void SetCallbacks(IPuzzlePingActions instance)
            {
                foreach (var item in m_Wrapper.m_PuzzlePingActionsCallbackInterfaces)
                    UnregisterCallbacks(item);
                m_Wrapper.m_PuzzlePingActionsCallbackInterfaces.Clear();
                AddCallbacks(instance);
            }
        }
